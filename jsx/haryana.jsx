...
import revenueData from "../haryanarevenue.json"
  ...
  return (
    <div>
        ...
        <div className='barchart'> 
                ...
                datasets:[
                    {
                        ...
                        data:[101000,121000,112000,135000,118000,176000,244000,220000,310000,260000,320000],
            ...
            <Doughnut 
                  data={{
                    labels:["Agriculture","Textile industry","Services","Real estate infrastructure","Tourism"],
                    datasets:[
                        {
